...
///////////////////////////////////////////////
  ...
  sprintf(text_title_pdf1, "Make_Plots_result_noextBNB.pdf(","" );
  can -> Print(text_title_pdf1);
  sprintf(text_title_pdf2, "Make_Plots_result_noextBNB.pdf","" );
  sprintf(text_title_pdf3, "Make_Plots_result_noextBNB.pdf)","" );
  sprintf(text_title_pdf4, "Make_Plots_result_noextBNB","" );
...
std::string Fake_data_file = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/Data/DATA_Selected_newCC0pi_addthresholds_rustv-high_stat_prodgenie_bnb_nu_overlay_DetVar_Run1_NuWro_reco2_reco2.root";
...
float BG_Trigger_scaler)
{
  ...
  TH1D* h_Data_BeamOn_clone2 =  GetTH1DHist(*TFile_Data, InputHisBaseName );
  TH1D* h_Data_BeamOFF_clone2 =  GetTH1DHist(*TFile_Data_BeamOff, InputHisBaseName );
  TH1D* h_MC_Total_clone2 =  GetTH1DHist(*TFile_MC, InputHisBaseName );
  
  TH1D* h_Data_BeamOn = (TH1D*) h_Data_BeamOn_clone2->Clone(); 
  TH1D* h_Data_BeamOFF = (TH1D*) h_Data_BeamOFF_clone2->Clone(); 
  TH1D* h_MC_Total = (TH1D*) h_MC_Total_clone2->Clone(); 
...
float BG_Trigger_scaler)
{
  ...
  TH1D* h_Data_BeamOn_clone =  GetTH1DHist(*TFile_Data, InputHisBaseName );
  TH1D* h_Data_BeamOFF_clone =  GetTH1DHist(*TFile_Data_BeamOff, InputHisBaseName );
  TH1D* h_MC_Total_clone =  GetTH1DHist(*TFile_MC, InputHisBaseName );
  
  TH1D* h_Data_BeamOn = (TH1D*) h_Data_BeamOn_clone->Clone(uniq());
  TH1D* h_Data_BeamOFF = (TH1D*) h_Data_BeamOFF_clone->Clone(uniq());
  TH1D* h_MC_Total = (TH1D*) h_MC_Total_clone->Clone(uniq());
...
char leg_title[1024];
  ...
  DrawStackMCandData(
   ...
   DrawFakeData();
    ...
    TH1D* h_Data_BeamOn_clone2 =(TH1D*)h_Data_BeamOn->Clone("h_Data_BeamOn_clone");
    TH1D* h_MC_Total_clone2 =(TH1D*)h_MC_Total->Clone("h_MC_Total_clone");

     h_Data_BeamOn_clone2->Divide(h_MC_Total_clone);
     h_Data_BeamOn_clone2->SetTitle("");
     h_Data_BeamOn_clone2->GetYaxis()->SetTitle("DATA / MC ");
     h_Data_BeamOn_clone2->GetXaxis()->SetTitle(Xaxis_title);
     h_Data_BeamOn_clone2->GetYaxis()->SetLabelSize(.1);
     h_Data_BeamOn_clone2->GetXaxis()->SetLabelSize(.1);
     h_Data_BeamOn_clone2->GetXaxis()->SetTitleSize(0.125);
     h_Data_BeamOn_clone2->GetYaxis()->SetTitleSize(0.09);
     ...
     h_Data_BeamOn_clone2->GetXaxis()->CenterTitle();
     h_Data_BeamOn_clone2->GetYaxis()->CenterTitle();
     h_Data_BeamOn_clone2->GetYaxis()->SetTitleOffset(.4);
     h_Data_BeamOn_clone2->GetXaxis()->SetTitleOffset(.8);
     h_Data_BeamOn_clone2->SetMinimum(.5);
     h_Data_BeamOn_clone2->SetMaximum(1.5);
     h_Data_BeamOn_clone2->Draw("Hist");
     TLine ratio_1;
     ratio_1.SetLineWidth(2);
     ratio_1.SetLineStyle(7);
     ratio_1.SetLineColor(kBlue);
...
float BG_Trigger_scaler)
{
  ...
  TH1D* h_Data_BeamOn = (TH1D*) h_Data_BeamOn_1->Clone(uniq());
  TH1D* h_Data_BeamOFF = (TH1D*) h_Data_BeamOFF_1->Clone(uniq());
  TH1D* h_MC_Total = (TH1D*) h_MC_Total_1->Clone(uniq());
  ...
  TH1D* h_Data_BeamOn_clone =(TH1D*)h_Data_BeamOn->Clone(uniq());
...
char leg_title[1024];
  ...
  for(auto &HistInMap : h_p_EventCategory_StackMap){
    DrawStackMCandData_EventCategory_tool.set_mc_histogram_style( HistInMap.first, HistInMap.second );
    TH1D* hist_input =(TH1D*)HistInMap.second->Clone(uniq());
    EventCategory_stack->Add( hist_input );
    double FractionArea = (HistInMap.second->Integral() / Total_Area_MC) * 100 ;
    sprintf(leg_title, " %s (%2.1f %)",HistInMap.second->GetTitle(),FractionArea );
    lg1_stacked->AddEntry(HistInMap.second, leg_title, "f" );
  }
