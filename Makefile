...
# make a binary for every .cxx file
 all : $(patsubst %.cpp, %.o, $(wildcard *.cpp)) Make_config_mcc9_2D_muon_CC0pi univmake HistMaker  HistMaker_test HistMaker_ForData HistMaker_ForData_Test HistMaker_For_FAKEData Make_Plots Make_Plots_2D Make_cc0pi_effpur_pmu Make_cc0pi_effpur Make_Plots_test migration_matrix_cc0pi tutorial_slice_plots_test Make_cc0pi_effpur_test HistMaker_newTuples HistMaker_For_FAKEData_newTuples
# cc0pi_analyzer_org
# cc0pi_analyzer
# # rule for each one
# 
