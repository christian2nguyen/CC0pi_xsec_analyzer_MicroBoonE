...
void cc0pi_effpur() {
 ...
 std::cout<<"Starting MakePlots"<< std::endl;
  ...
  sprintf(text_title_pdf1, "CC0pi_CUT_eff_pur_Figures_Pion_Selection.pdf(");
  c1 -> Print(text_title_pdf1);
  sprintf(text_title_pdf2, "CC0pi_CUT_eff_pur_Figures_Pion_Selection.pdf" );
  sprintf(text_title_pdf3, "CC0pi_CUT_eff_pur_Figures_Pion_Selection.pdf)");
  sprintf(text_title_pdf4, "CC0pi_CUT_eff_pur_Figures_Pion_Selection");
  ...
  const std::vector< std::string > selection_defs = {
    ...
    "sel_reco_vertex_in_FV && sel_pfp_starts_in_PCV && sel_topo_cut_passed && sel_no_reco_showers && sel_muon_passed_mom_cuts",
    "sel_reco_vertex_in_FV && sel_pfp_starts_in_PCV && sel_topo_cut_passed && sel_no_reco_showers && sel_muon_passed_mom_cuts && sel_has_pi_candidate",
    "sel_reco_vertex_in_FV && sel_pfp_starts_in_PCV && sel_topo_cut_passed && sel_no_reco_showers && sel_muon_passed_mom_cuts && sel_pions_above_threshold &&  sel_has_pi_candidate",
    "sel_reco_vertex_in_FV && sel_pfp_starts_in_PCV && sel_topo_cut_passed && sel_no_reco_showers && sel_muon_passed_mom_cuts && sel_pions_above_threshold && sel_has_pi_candidate && pion_multiplicity > 0;"
...
//sel_pions_above_threshold && sel_has_pi_candidate && pion_multiplicity > 0
    ...
    "sel\\_reco\\_vertex\\_in\\_FV \\&\\& sel\\_pfp\\_starts\\_in\\_PCV \\&\\& sel\\_topo\\_cut\\_passed & sel\\_no\\_reco\\_showers \\&\\& sel\\_muon\\_passed\\_mom\\_cuts",
    "sel\\_reco\\_vertex\\_in\\_FV \\&\\& sel\\_pfp\\_starts\\_in\\_PCV \\&\\& sel\\_topo\\_cut\\_passed & sel\\_no\\_reco\\_showers \\&\\& sel\\_muon\\_passed\\_mom\\_cuts \\&\\& sel\\_has\\_pi\\_candidate",
    "sel\\_reco\\_vertex\\_in\\_FV \\&\\& sel\\_pfp\\_starts\\_in\\_PCV \\&\\& sel\\_topo\\_cut\\_passed & sel\\_no\\_reco\\_showers \\&\\& sel\\_muon\\_passed\\_mom\\_cuts \\&\\& sel\\_pions\\_above\\_threshold \\&\\&  sel\\_has\\_pi\\_candidate",
    "sel\\_reco\\_vertex\\_in\\_FV \\&\\& sel\\_pfp\\_starts\\_in\\_PCV \\&\\& sel\\_topo\\_cut\\_passed & sel\\_no\\_reco\\_showers \\&\\& sel\\_muon\\_passed\\_mom\\_cuts \\&\\& sel\\_pions\\_above\\_threshold \\&\\& sel\\_has\\_pi\\_candidate \\&\\& \\&\\& pion\\_multiplicity > 0"
     };
...
stv_ch.Add( "/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_2_11_24/rustv-prodgenie_bnb_nu_uboone_overlay_mcc9.1_v08_00_00_26_filter_run1_reco2_reco2.root");
  ...
  //formula.SetParameter(0, .28);
     std::ofstream outFile("Latex_Cut_table_pionSideBand.txt");
