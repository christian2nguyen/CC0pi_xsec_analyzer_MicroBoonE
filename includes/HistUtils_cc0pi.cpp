...
{kProj_InclBin2, {4,5,6,7,8}},
{kProj_InclBin3, {9,10,11,12,13}},
{kProj_InclBin4, {14,15,16,17}},
{kProj_InclBin5, {18,19,20,21,22}},
{kProj_InclBin6, {23,24,25,26,27,28}},
{kProj_InclBin7, {29,30,31,33}},
{kProj_InclBin8, {34,35,36,37,38}},
{kProj_InclBin9, {39,40,41,42,43,44}} 
};
...
std::vector<double> GetCCZeroPi_Binning(variable_binning inputVar){
 ...
 switch (inputVar) {
    ...
    case kBINNING_Pmu:
    bins_vec = {0.1, 0.275, 0.375, 0.525, 0.7, 0.9, 1.1, 2.};
    return bins_vec;

    case kBINNING_Costheta:
    bins_vec = {-1., -0.525, -0.375, -0.225, -0.1, 0.025, 0.15, 0.275, 0.45, 0.6, 0.775, 0.925, 1.};
    return bins_vec;
